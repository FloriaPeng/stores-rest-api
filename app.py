...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///data.db' # link to database, "/data.db" means that it is put in the root folder
...
def create_tables():
    db.create_all() # create all tables in data.db
